...
path15=r'/content/drive/MyDrive/Colab Notebooks/from_3_4.parquet'
path4=r"/content/drive/MyDrive/Colab Notebooks/from_2_4.parquet"
path1=r"/content/drive/MyDrive/Colab Notebooks/from_1_4.parquet"
...
ki=ccxt.binance()
ku=ccxt.kucoin()
path15=r'/content/drive/MyDrive/Colab Notebooks/from_3_3.parquet'
path15_=r'/content/drive/MyDrive/Colab Notebooks/from_3_4.parquet'

path4=r"/content/drive/MyDrive/Colab Notebooks/from_2_3.parquet"
path4_=r"/content/drive/MyDrive/Colab Notebooks/from_2_4.parquet"

path1=r"/content/drive/MyDrive/Colab Notebooks/from_1_3.parquet"
path1_=r"/content/drive/MyDrive/Colab Notebooks/from_1_4.parquet"

path_f15=Path(r'/content/drive/MyDrive/Colab Notebooks/from_3_3.feather')
path_f4=Path(r'/content/drive/MyDrive/Colab Notebooks/from_2_3.feather')
path_f1=Path(r'/content/drive/MyDrive/Colab Notebooks/from_1_3.feather')
